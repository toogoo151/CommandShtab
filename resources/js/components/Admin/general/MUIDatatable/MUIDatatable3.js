...
const MUIDatatable2 = (props) => {
    ...
    const options = {
        ...
        selectableRows: "none", // Row click-ийг устгах
        responsive: "standard",
        fixedHeader: false,
        tableBodyHeight: "50vh",
        customToolbarSelect: null, // Дээд талын tool-ыг зайлуулах
        customFooter: null, // Доод талын tool-ыг зайлуулах
        count: 0, // Хуудасны тоо зайлуулах
        rowsPerPage: 0, // Хуудас бүрийн мөрийн тоо
        elevation: 0, // Хүснэгтийн сүүдэргүй болгох
        pagination: false, // Хуудас хуваалтгүй болгох
