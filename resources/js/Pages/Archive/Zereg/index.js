...
import BelenBaidalEdit from "./BelenBaidalEdit";
import BelenBaidalNew from "./BelenBaidalNew";

const BelenBaidalIndex = () => {
                ...
                <div className="info-box">
                    <div className="col-md-12">
                        ...
                        <MUIDatatable
                            ...
                            btnEdit={btnEdit}
                            modelType={showModal}
                            editdataTargetID={"#belenBaidalEdit"}
                            btnDelete={btnDelete}
                            avgColumnIndex={-1}
                            avgColumnName={"email"}
                            avgName={"Дундаж: "}
                            ...
                            isHideEdit={true}
                        />
                        <BelenBaidalNew refreshData={refreshData} />
                        <BelenBaidalEdit
                            setRowsSelected={setRowsSelected}
...
export default BelenBaidalIndex;
